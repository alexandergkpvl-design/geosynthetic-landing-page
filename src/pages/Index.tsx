    ...
    <div className="min-h-screen">
      <header className="fixed top-0 w-full bg-primary/95 backdrop-blur-sm z-50 border-b border-border">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="text-2xl font-bold text-primary-foreground">ГеоСнаб</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-lg text-muted-foreground mb-12">
              <p>
                <span className="font-bold text-foreground">ГеоСнаб</span> — надежный поставщик геосинтетических материалов с многолетним опытом работы на российском рынке.
              </p>
              <p>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <a href="tel:+78001234567" className="text-xl text-accent hover:underline">
                    +7 (800) 123-45-67
                  </a>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <a href="mailto:info@geosnab.ru" className="text-xl text-accent hover:underline">
                    info@geosnab.ru
                  </a>
                </div>
              </div>
