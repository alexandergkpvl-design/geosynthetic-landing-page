...
const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Да, возврат возможен в течение 14 дней при условии, что товар не был в употреблении и сохранена упаковка. Все вопросы по возврату решаются индивидуально.",
    },
  ];
